...
import Tributes from "./components/_Tributes/Tributes";
import TributeDetail from "./components/_TributeEdit/TributeEdit";
import Events from "./components/_Events/Events";
import Maps from "./components/_Maps/Maps";
import Items from "./components/_Items/Items";
import Games from "./components/_Games/Games";
import GameDetail from "./components/_GameEdit/GameEdit";
